...
from keras.layers import Permute, Activation, Dense, Flatten, Input, Lambda, Reshape
...
class PACRR(MODEL_BASE):
    ...
    def build_doc_scorer(self, r_query_idf, permute_idxs):
        ...
        if p['combine'] < 0:
            ...
            # correspond to the PACRR model described in our EMNLP17 paper
            ...
            # correspond to the PACRR model described in the backround in Neu-IR 17 paper.
